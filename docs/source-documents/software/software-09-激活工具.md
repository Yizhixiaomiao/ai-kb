...
tags: [software, software-catalog, installer, 软件下载, 安装包, 下载路径, 软件库路径, 09_激活工具, activation, kms, 激活工具, KMS]
...
- 卫华集团内网激活助手（以管理员身份运行）.bat。软件库路径：`/09_激活工具/卫华集团内网激活助手（以管理员身份运行）.bat`；页面入口：http://soft.craneweihua.com/；大小：2.7 KB；更新时间：2024-02-26T11:41:02.000003+08:00。

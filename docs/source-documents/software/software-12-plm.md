...
systems: [software-repository, plm]
issue_types: [software-installation, driver-installation, client-installation, download-reference]
tags: [software, software-catalog, installer, 软件下载, 安装包, 下载路径, 软件库路径, 12_PLM, plm, PLM客户端, PLM安装包]
...
- PLM客户端.zip。软件库路径：`/12_PLM/PLM客户端.zip`；页面入口：http://soft.craneweihua.com/；大小：465.2 MB；更新时间：2024-12-19T12:06:07+08:00。

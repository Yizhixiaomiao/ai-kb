...
tags: [software, software-catalog, installer, 软件下载, 安装包, 下载路径, 软件库路径, 脚本, script]
...
- Workstation.bat。软件库路径：`/脚本/Workstation.bat`；页面入口：http://soft.craneweihua.com/；大小：558 B；更新时间：2025-04-08T13:36:37.000004+08:00。
